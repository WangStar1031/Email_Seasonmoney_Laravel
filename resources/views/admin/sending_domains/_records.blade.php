<table class="table table-trans tbody-white" class="table-layout:fixed">
    ...
    <tbody class="bg-white">
        <tr>
            ...
            <td width="20%">
                <a href="#" data-type="text" data-pk="1" data-url="{{ action('Admin\SendingDomainController@updateVerificationTxtName', $server->uid) }}" data-title="{{ trans('messages.sending_domain.verification_hostname.enter') }}" class="inline-editable">
        ...
        <tr>
            ...
            <td>
                <a href="#" data-type="text" data-pk="1" data-url="{{ action('Admin\SendingDomainController@updateDkimSelector', $server->uid) }}" data-title="{{ trans('messages.sending_domain.dkim_selector.enter') }}" class="inline-editable">
